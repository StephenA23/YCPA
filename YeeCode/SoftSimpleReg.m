...
%%{
% S
epi{1}(5:15, 87:100) = c_eps_0*11.3; 
epi{1}(5:40, 97:100) = c_eps_0*11.3; 
epi{1}(5:40, 86:89) = c_eps_0*11.3; 
epi{1}(5:40, 75:78) = c_eps_0*11.3;
epi{1}(35:40, 78:89) = c_eps_0*11.3;

% T
epi{1}(62:72, 75:100) = c_eps_0*11.3; 
epi{1}(45:90, 97:100) = c_eps_0*11.3; 

% E
epi{1}(95:105, 75:100) = c_eps_0*11.3;
epi{1}(95:140, 75:78) = c_eps_0*11.3; 
epi{1}(95:140, 86:89) = c_eps_0*11.3; 
epi{1}(95:140, 97:100) = c_eps_0*11.3; 

% P
epi{1}(145:155, 75:100) = c_eps_0*11.3; 
epi{1}(145:190, 97:100) = c_eps_0*11.3; 
epi{1}(145:190, 86:89) = c_eps_0*11.3; 
epi{1}(185:190, 89:97) = c_eps_0*11.3; 

%END of structure
%}
%Tried STEPHEN, but not enough
